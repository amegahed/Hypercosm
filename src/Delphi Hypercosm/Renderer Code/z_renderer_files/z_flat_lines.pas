...
{***************************************************************}
{ |\  /|                                               We Put   }
{ | >< Hypercosm           z_flat_lines                3d       }
{ |/  \|                                               To Work! }
{***************************************************************}
{                                                               }
{       This module contains the basic routines for scan        }
{       converting flat shaded lines.                           }
{                                                               }
{***************************************************************}
...
{ drawing routines }
{******************}
procedure Flat_shade_z_line(z_renderer: z_renderer_type);
procedure Flat_shade_z_thick_line(z_renderer: z_renderer_type;
  thickness: real);
...
end; {procedure Flat_shade_z_line}


procedure Flat_shade_z_thick_line_polygon(z_renderer: z_renderer_type;
  z_line_ptr: z_line_ptr_type;
  z_vertex_ptr1, z_vertex_ptr2: z_vertex_ptr_type;
  thickness: real);
var
...
end; {procedure Flat_shade_z_thick_line_polygon}
...
begin
  ...
  while (z_line_ptr <> nil) do
    begin
      ...
      if z_vertex_ptr <> nil then
        while (z_vertex_ptr^.next <> nil) do
          begin
            Flat_shade_z_thick_line_polygon(z_renderer, z_line_ptr, z_vertex_ptr,
  ...
  Free_z_vertex_list(z_line_list);
end; {procedure Flat_shade_z_thick_line}
