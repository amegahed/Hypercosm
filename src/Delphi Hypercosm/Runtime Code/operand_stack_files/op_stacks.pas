...
begin
  ...
  stack_ptr := stack_ptr_type(New_ptr(size * sizeof(stack_type)));
...
begin
  stack_index := operand_stack_top_ptr^.stack_index;
  operand_stack_top_ptr := stack_ptr_type(longint(operand_stack_top_ptr) -
    sizeof(stack_type));
...
begin
  heap_index := operand_stack_top_ptr^.heap_index;
  operand_stack_top_ptr := stack_ptr_type(longint(operand_stack_top_ptr) -
    sizeof(stack_type));
...
var
  handle: handle_type;
begin
  handle := operand_stack_top_ptr^.handle;
  operand_stack_top_ptr := stack_ptr_type(longint(operand_stack_top_ptr) -
    sizeof(stack_type));
...
var
  memref: memref_type;
begin
  memref := operand_stack_top_ptr^.memref;
  operand_stack_top_ptr := stack_ptr_type(longint(operand_stack_top_ptr) -
    sizeof(stack_type));
...
begin
  type_ptr := operand_stack_top_ptr^.type_ptr;
  operand_stack_top_ptr := stack_ptr_type(longint(operand_stack_top_ptr) -
    sizeof(stack_type));
...
begin
  code_ptr := operand_stack_top_ptr^.code_ptr;
  operand_stack_top_ptr := stack_ptr_type(longint(operand_stack_top_ptr) -
    sizeof(stack_type));
...
function Peek_stack_index_operand: stack_index_type;
begin
  Peek_stack_index_operand := operand_stack_top_ptr^.stack_index;
end; {function Peek_stack_index_operand}


function Peek_heap_index_operand: heap_index_type;
begin
  Peek_heap_index_operand := operand_stack_top_ptr^.heap_index;
end; {function Peek_heap_index_operand}


function Peek_handle_operand: handle_type;
begin
  Peek_handle_operand := operand_stack_top_ptr^.handle;
end; {function Peek_handle_operand}


function Peek_memref_operand: memref_type;
begin
  Peek_memref_operand := operand_stack_top_ptr^.memref;
